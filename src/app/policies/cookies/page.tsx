    ...
    <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
      <Card className="max-w-4xl mx-auto shadow-lg">
        <CardHeader className="text-center pb-8">
          <CardTitle className="text-3xl md:text-4xl font-headline text-primary">Cookie Policy</CardTitle>
        ...
        <CardContent className="space-y-6 text-muted-foreground">
          <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">1. Introduction</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">2. What are cookies?</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">3. Why do we use cookies?</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">4. Types of Cookies We Use</h2>
           ...
           <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">5. How can you control cookies?</h2>
            <p>
           ...
           <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">6. Changes to This Cookie Policy</h2>
            <p>
             We may update this Cookie Policy from time to time in order to reflect, for example, changes to the cookies we use or for other operational, legal, or regulatory reasons. Please therefore re-visit this Cookie Policy regularly to stay informed about our use of cookies and related technologies.
            </p>
          </div>
           <div>
            <h2 className="text-xl font-bold font-headline text-foreground mb-2">7. Contact Us</h2>
            <p>
