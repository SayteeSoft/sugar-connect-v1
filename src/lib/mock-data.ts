...
export const allProfiles: UserProfile[] = [
  {
    ...
    profileImage: 'https://placehold.co/400x400/E6E6FA/800080',
    isVerified: true,
    gallery: [
  ...
  },
  {
    ...
    profileImage: 'https://placehold.co/400x400/800080/E6E6FA',
    isVerified: true,
    gallery: [
...
export const featuredProfiles: UserProfile[] = allProfiles.slice(0, 4);
...
export const conversations = [
    {
      ...
      avatar: 'https://placehold.co/400x400/800080/E6E6FA',
      unreadCount: 2,
    },
    {
      id: 'conv2',
