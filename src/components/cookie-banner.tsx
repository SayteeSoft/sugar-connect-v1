    ...
    <Dialog open={showModal} onOpenChange={setShowModal}>
      <DialogContent className="max-w-4xl">
        ...
        <div className="max-h-[60vh] overflow-y-auto pr-4 text-sm text-muted-foreground space-y-4">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-1">1. What are cookies?</h3>
              <p>
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-1">2. Why do we use cookies?</h3>
              <p>
            ...
            <div>
                <h3 className="font-semibold text-foreground mb-1">3. Types of Cookies We Use</h3>
             ...
             <div>
              <h3 className="font-semibold text-foreground mb-1">4. How can you control cookies?</h3>
              <p>
             ...
             <div>
              <h3 className="font-semibold text-foreground mb-1">5. Changes to This Cookie Policy</h3>
              <p>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleAccept}>Accept and Close</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
